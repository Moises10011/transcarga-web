...
public class VehiculoService {
    ...
    public List<Vehiculo> buscarPorTipo(Vehiculo.TipoVehiculo tipo) { return vehiculoRepository.findByTipoVehiculo(tipo); }

    public List<Vehiculo> buscarPorTipoCarga(Long tipoCargaId) { return vehiculoRepository.findByTipoCargaCompatibleId(tipoCargaId); }

    public List<Vehiculo> buscarPorConductor(Long conductorId) { return vehiculoRepository.findByConductorId(conductorId); }

    public Vehiculo crear(Vehiculo vehiculo) { return vehiculoRepository.save(vehiculo); }
